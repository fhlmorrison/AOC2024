 ...
 */
export function makeWords(input: string, delimiter: string | RegExp = /\s+/): string[] {
 ...
 */
export function makeNumbers(input: string, delimiter: string | RegExp = /\s+/): number[] {
 ...
 */
export function makeMatrix(input: string, delimiter: string | RegExp = /\s+/, asNums: boolean = false): string[][] {
 ...
 */
export function makeNumberMatrix(input: string, delimiter: string | RegExp = /\s+/): number[][] {
...
export function windows<T>(arr: T[], size: number): T[][] {
    return arr.map((_, i) => arr.slice(i, i + size)).filter(sub => sub.length === size);
}